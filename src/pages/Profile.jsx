...
const navigation = [
  ...
  { name: 'Profile', href: '#', icon: CogIcon, current: true },
];
...
const convertToPST = (data) => {
  const inputDate = moment.utc(data, 'ddd, DD MMM YYYY HH:mm:ss [GMT]');
  const outputDate = inputDate
    .tz('America/Los_Angeles')
    .format('ddd, DD MMM YYYY h:mm:ss A z');
  return outputDate;
};
                          ...
                          <dl className='divide-y divide-gray-200'>
                            ...
                            <div className='py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:pt-5'>
                              ...
                              <dd className='mt-1 flex text-sm text-gray-900 sm:mt-0 sm:col-span-2'>
                                <span className='flex-grow'>
                                  {user.metadata
                                    ? convertToPST(user.metadata.creationTime)
                                    : 'N/A'}
                                </span>
                                <span className='ml-4 flex-shrink-0 flex items-start space-x-4'>
                                  <button
                            ...
                            <div className='py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4'>
                              ...
                              <dd className='mt-1 flex text-sm text-gray-900 sm:mt-0 sm:col-span-2'>
                                <span className='flex-grow'>
                                  {user.metadata
                                    ? convertToPST(user.metadata.lastSignInTime)
                                    : 'N/A'}
                                </span>
                                <span className='ml-4 flex-shrink-0'>
                                  <button
